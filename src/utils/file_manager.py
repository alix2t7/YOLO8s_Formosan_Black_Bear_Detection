...
class FileManager:
    ...
    def create_project_structure(self, project_dir: Union[str, Path]) -> Dict[str, Path]:
        """創建項目目錄結構"""
    ...
    def calculate_checksum(self, filepath: Union[str, Path], 
    ...
    def save_manifest(self, directory: Union[str, Path], 
